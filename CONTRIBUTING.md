...
People are expected to follow the [Scala Code of Conduct](./CODE_OF_CONDUCT.md) when discussing sendgrid4s on the Github page, Gitter channel, or other venues.
...
```
Copyright (c) $today.year the sendgrid4s contributors.
